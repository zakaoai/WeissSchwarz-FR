const frenchTranslation = {
  ...
  "ATLA/WX04-T02": [
    ...
    "【AUTO】 Quand cette carte est placé sur le stage depuis votre main, révéler la première carte de votre deck. Si cette carte est un événement ou un personnage de《World of Avatar》, vous pouvez la mettre face caché sous cette carte en tant que marquer. (Dans le cas contraire, elle retourne à sa place original)"
  ],
  "ATLA/WX04-T03": [
    "【CONT】 Cette carte gagne +500 de puissance pour chaque autres personnages de《World of Avatar》."
  ],
  "ATLA/WX04-T04": [
  ...
  "ATLA/WX04-T05": [
    ...
    "【ACT】 【COUNTER】 Backup 1000, Level 1 [Mettez cette carte de votre main dans la waiting room] (Choisissez 1 de vos personnage qui subbit une attaque frontal, cette carte gagne +1000 de puissance jusqu'à la fin du tour)"
  ],
  "ATLA/WX04-T06": [
    "【CONT】 Assist Tout vos personnages devant cette carte gagne +X de puissance. X est égale au niveau de ce personnage ×500.",
